...
REM
REM Generated by Vivado on Tue Dec 02 01:49:03 +0530 2025
...
echo "xvlog --incr --relax -prj tb_data_transfer_vlog.prj"
call xvlog  --incr --relax -prj tb_data_transfer_vlog.prj -log xvlog.log
